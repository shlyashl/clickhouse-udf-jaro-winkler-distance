create or replace function jaroWinklerDistance on cluster cluster1 as (string1, string2) ->
if(
    ...
    (
        ...
        from (
            select
                string1,
                string2,
                cast(floor(least(lengthUTF8(string1), lengthUTF8(string2)) / 2), 'UInt16')        as limit,
                    ...
                    (
                        indexOf(
                            arrayMap(
                                ...
                                range(toInt16(least(lengthUTF8(string1), lengthUTF8(string2), 4)) as prefix_chars_cnt)
                            )                                                           as prefix_len_tmp,
                            0
            ...
            floor((jaro + 0.1 * prefix_len * (1 - jaro))*1000)/1000                       as jaro_winkler_value
        )
    )
);
